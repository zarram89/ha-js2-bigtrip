...
import {formatTripDate, formatTime, getDuration} from '../utils.js';
      ...
      <li class="trip-events__item">
        <div class="event">
          ...
          <ul class="event__selected-offers">
            ${offers.map((offer) => `<li class="event__offer"><span class="event__offer-title">${offer.title}</span> &plus;&euro;&nbsp;<span class="event__offer-price">${offer.price}</span></li>`).join('')}
          </ul>
